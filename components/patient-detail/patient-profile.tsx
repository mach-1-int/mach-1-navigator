...
// Mock supervisor lookup (not in demo context)
const mockSupervisorData: Record<string, { id: string; name: string; region: string }> = {
...
export function PatientProfile({ patientId }: PatientProfileProps) {
  ...
  const supervisor = useMemo(() => {
    if (!patient) return null
    return mockSupervisorData[patient.assignedSupervisor]
  }, [patient])

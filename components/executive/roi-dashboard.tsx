...
export function ROIDashboard() {
  const { patients, referrals, timeLogs, notes, isHydrated } = useDemoData()
  ...
  const summary = getDashboardSummary(patients, timeLogs, navigatorsWithAttributes)
  const operationalMetrics = getOperationalMetrics(referrals, navigatorsWithAttributes, notes)
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Card className="bg-card">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Based on logged time (60min = $100)
            </p>
          </CardContent>
        </Card>

        {/* Compliance Rate (Mocked) */}
        <Card className="bg-card">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium text-muted-foreground">
              Compliance Rate
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="border-l-4 border-l-purple-500">
          <CardContent className="pt-4">
            ...
            <div className="text-2xl font-bold">{operationalMetrics.avgTurnaroundDays} days</div>
            <p className="text-xs text-muted-foreground">
              Referral to first note
            </p>
          </CardContent>
        </Card>
